...
parser.add_argument('-pid', '--peer_id', help='Id of the peer to synce from after startup')
parser.add_argument('-pport', '--peer_port', help='Port of the peer to connect to')
