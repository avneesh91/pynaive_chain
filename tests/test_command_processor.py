...
class TestCommandProcessor(unittest.TestCase):
  ...
  UPLOAD_DICT = {
      ...
      "data_list": [{
          ...
          'data':
              '"initial_hash"',
          'curr_hash':
              '814a4bf857f49f4542355fe9d6bafc2c59486b62ef731defba1d7ea2fc6a095e'
      }, {
          'index':
              1,
          'previous_hash':
          ...
          'data':
              '"initial_hash1"',
          'curr_hash':
              'b247d67fb2bd7d4ee506416b2d3e89d8630ee8e6a6f1c8fe5a5d41a560cdaac4'
      }]
  }
  ...
  def setUp(self):
    ...
    self.mock_chain_instance.get_peer_id_list.return_value = [
        'peer_id_1', 'peer_id_2', 'peer_id_3'
    ]
    self.mock_chain_instance.block_data.return_value = Block(
        0, 'test_data', 'initial_hash')
    self.mock_chain_instance.get_block_data.return_value = [
        Block(0, 'test_data', 'initial_hash'),
        Block(1, 'test_data1', 'initial_hash1')
    ]
    self.mock_chain_instance.get_peer.return_value = {
        'host': '0.0.0.0',
        'port': '1234'
    }
